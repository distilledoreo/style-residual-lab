import { readinessReport, selectedTargetConfigFromEnv, writeReadinessReport } from "./privateModernCorpus.js";
...
const report = await readinessReport(selectedTargetConfigFromEnv());
